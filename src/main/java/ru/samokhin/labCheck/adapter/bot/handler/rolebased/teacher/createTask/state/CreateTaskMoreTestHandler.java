...
public class CreateTaskMoreTestHandler implements CreateTaskStateHandler {
    ...
    public StatusData handle(CreateTaskContext context, String input) {
        ...
        switch (input) {
            ...
            case "Да" -> nextState = CreateTaskState.CREATE_TASK_AWAITING_TEST_NAME;
            case "Нет" -> nextState = CreateTaskState.CREATE_TASK_FILL_DATA;
            default -> {
